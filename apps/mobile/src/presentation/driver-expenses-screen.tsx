...
export function DriverExpensesScreen({ session }: { session: Session }) {
  ...
  const reset = () => { setCategory('petrol'); setTypeDetail(''); setAmount(''); setExpenseDate(localDateValue()); setNotes('') }
