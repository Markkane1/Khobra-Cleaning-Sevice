    ...
    <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <Pressable accessibilityRole="button" disabled={submitting || !signup.turnstileToken} onPress={submit} style={({ pressed }) => [styles.submit, pressed && styles.submitPressed, (submitting || !signup.turnstileToken) && styles.submitDisabled]}>
...
const styles = StyleSheet.create({
  ...
  brandName: { marginTop: 13, fontFamily: headingFont, fontSize: 27, fontWeight: '700', color: '#12372a', letterSpacing: -0.5 },
  ...
  form: { gap: 14 },
  field: { gap: 7 },
  label: { color: '#344b42', fontSize: 12, fontWeight: '700' },
  input: { height: 50, borderRadius: 13, borderWidth: 1, borderColor: '#ccdad4', backgroundColor: '#fbfdfc', color: '#15251d', paddingHorizontal: 15, fontSize: 15 },
  notice: { alignSelf: 'flex-start', borderRadius: 999, backgroundColor: '#d1fae5', paddingHorizontal: 11, paddingVertical: 6 },
  noticeText: { color: '#047857', fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5 },
